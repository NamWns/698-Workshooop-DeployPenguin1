...
culmen_length_input = st.slider('Enter culmen length:', 0, 70, 70)
culmen_depth_input = st.number_input('Enter culmen depth in mm (0 to 60):', min_value=0, max_value=60)
flipper_length_input = st.number_input('Enter flipper length in mm (0 to 300):', min_value=0, max_value=300)
